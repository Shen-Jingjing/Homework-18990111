...
import com.example.thefinalapplication.bean.UserInfo;
import com.example.thefinalapplication.database.UserDBHelper;
import com.example.thefinalapplication.util.DateUtil;
import com.example.thefinalapplication.util.ViewUtil;
...
public class LoadActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","18990111 沈晶晶"};
