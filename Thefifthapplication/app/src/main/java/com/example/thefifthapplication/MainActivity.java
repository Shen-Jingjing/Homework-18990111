package com.example.thefifthapplication;
...
import com.example.thefifthapplication.bean.UserInfo;
import com.example.thefifthapplication.datebase.UserDBHelper;
import com.example.thefifthapplication.util.DateUtil;
import com.example.thefifthapplication.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"学生", "教师","18990111沈晶晶"};
